...
<div class="content">
    <div class="container-fluid" style="margin-top: 87px;">
        ...
        <section class="py-5">
            ...
            <div class="container">
                <div class="row row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-5 mb-3 text-center d-flex justify-content-center" style="margin-top: 60px; margin-bottom: 60px;">
                    ...
                    <div class="col-lg-2">
                        <div class="card mb-4 rounded-3 shadow-sm" style="width: 250px;">
                            ...
                            <div class="card-body">
                                ...
                                <a type="button" class="w-80 btn btn-lg btn-outline-primary" href="{{ url('/' . $top['ref']) }}">Details</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
        ...
        <!-- Membership -->
        <section class="py-5">
            <div class="container rounded" style="margin-top: 100px; height: 640px; background-image: url('https://images.samsung.com/is/image/samsung/assets/id/homepage/main-homepage/2023/web-shop-app.jpg');">
                <div class="container d-flex align-items-center" style="height: inherit;">
                    <div class="row mx-5">
                        <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <input type="email" class="form-control py-2" id="exampleFormControlInput1" placeholder="Enter Email Address" required>
                                </div>
                                <div class="col-md-3">
        ...
        <section class="py-5">
            <div class="container" style="margin-top: 100px;">
                <div class="row text-center">
                    <div class="col-lg-4">
                        <img class="bd-placeholder-img rounded" width="110" height="110" src="https://assets.website-files.com/644e3dd8d74e611a900b6b4c/6458b6182cb0bb3c19973a80_car.svg" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false" style="margin-bottom: 20px;">
                    ...
                    <div class="col-lg-4">
                        <img class="bd-placeholder-img rounded" width="110" height="110" src="https://assets.website-files.com/644e3dd8d74e611a900b6b4c/6458b618aa291004f9e74b27_safe-payment.svg" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false" style="margin-bottom: 20px;">
                    ...
                    <div class="col-lg-4">
                        <img class="bd-placeholder-img rounded" width="110" height="110" src="https://assets.website-files.com/644e3dd8d74e611a900b6b4c/6458b61822d8d77750748bb1_help-center.svg" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false" style="margin-bottom: 20px;">
