    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('images/zephyrus.jpg') }}" class="d-block w-100 object-fit-fill" alt="test image">
            </div>
                ...
                <div class="col-lg-2">
                    <div class="card mb-4 rounded-3 shadow-sm" style="width: 250px;">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="w-80 btn btn-lg btn-outline-primary">Beli bang</button>
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    <section class="py-5">
        <div class="container rounded"
            ...
            <div class="container d-flex align-items-center" style="height: inherit;">
                <div class="row mx-5">
                    <div class="col-md-7">
                        <p style="color: white; font-size: 45px; font-weight: bold;">Subscribe To Our Email And Get 25%
                            Off</p>
                        <div class="row">
                            <div class="col-md-9">
