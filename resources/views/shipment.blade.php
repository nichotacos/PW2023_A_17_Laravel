        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-check my-3 d-flex align-items-center me-3">
                    <label class="form-check-label d-flex align-items-center me-3 w-100 col-lg-10"
                        for="flexRadioDefault1">
                        <div class="col-lg-3">
                            <img src="https://images.tokopedia.net/img/toppay/sprites/bca.png" style="width: 80%;">
                        </div>
                        <div class="col-lg-9">
                            <p class="ms-2 d-flex align-items-center my-auto"
                                style="font-size: 18px; font-weight: bold;">BCA
                                Virtual Account</p>
                        </div>

                    </label>
                    <input class="form-check-input me-3 col-lg-1 text-start" type="radio" name="flexRadioDefault"
            ...
            <div class="modal-footer">
                <button type="button" class="btn" data-bs-target="#confirmModal" data-bs-toggle="modal"
                    style="background-color: #5FE137; color: white; font-weight: bold;">Pay</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a type="button" class="btn" href="{{ url('/') }}"
                    style="background-color: #5FE137; color: white; font-weight: bold;">Back to Home</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container py-3" style="margin-top: 80px;">
        ...
        <div class="row">
            <div class="container col-md-8">
                ...
                <p class="my-1" style="font-weight: bold;">{{ $item['name'] }}</p>
                <p class="my-1">{{ $item['telephone'] }}</p>
                <p class="my-1 text-muted">{{ $item['address'] }}</p>
                @endforeach
                <hr>
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="container d-flex align-items-start px-2 py-2">
                            <div class="card container px-2 py-2">
                                <div class="row mx-4 d-flex justify-content-between">
                                    <div class="col-md-3 px-2 py-2 text-center"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12 d-flex justify-content-between">
                                ...
                                <p class="card-text my-1">Rp 45,498,000</p>
                            </div>
                            <div class="col-md-12  d-flex justify-content-between">
                                <p class="card-text my-1">Total Shipping Fee</p>
                                <p class="card-text my-1">Rp 21,200</p>
                            </div>
                            <div class="col-md-12  d-flex justify-content-between">
                                <p class="card-text my-1">Admin Fee</p>
                                <p class="card-text my-1">Rp 1,000</p>
                            </div>
                            <hr />
                            <div class="col-md-12 d-flex justify-content-between py-2 mb-1">
                                <h5 class="card-title" style="font-weight: bold;">Grand Total</h5>
                                <h5 class="card-title" style="font-weight: bold;">Rp 45,520,200</h5>
                            </div>
                            <a href="{{ url('/shipment') }}" class="btn buy-button px-4" type="button"
                                data-bs-toggle="modal" data-bs-target="#paymentModal"
                                style="background-color: #5FE137; font-weight: bold; color: white; width: 100%;">Select
                                Payment
                                Method</a>
                        </div>
                    </div>
